  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-100 relative overflow-hidden">
      ...
      <div className="fixed inset-0 opacity-3 pointer-events-none z-0">
        ...
        <div className="absolute top-16 left-16 w-32 h-32 transform -rotate-12">
          <img 
            src="/banana-superhero-logo-transparent.png" 
            alt="" 
            className="w-full h-full object-contain"
        ...
        <div className="absolute top-1/3 right-8 w-36 h-36 transform rotate-45">
          <img 
            src="/banana-superhero-logo-transparent.png" 
            alt="" 
            className="w-full h-full object-contain"
        ...
        {/* 中央 */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 opacity-2">
          <img 
            src="/banana-superhero-logo-transparent.png" 
            alt="" 
            className="w-full h-full object-contain"
        ...
        {/* 边角装饰 */}
        <div className="absolute bottom-12 right-16 w-28 h-28 transform rotate-6">
          <img 
            src="/banana-superhero-logo-transparent.png" 
            alt="" 
            className="w-full h-full object-contain"
        ...
        <div className="absolute top-24 right-1/3 w-24 h-24 transform -rotate-45 opacity-4">
          <img 
            src="/banana-superhero-logo-transparent.png" 
            alt="" 
            className="w-full h-full object-contain"
        ...
        <div className="absolute bottom-1/3 left-1/4 w-20 h-20 transform rotate-30 opacity-3">
          <img 
            src="/banana-superhero-logo-transparent.png" 
            alt="" 
            className="w-full h-full object-contain"
