          ...
          className={`w-24 h-24 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg ${
            !imageState.file 
              ...
              : isGenerating 
                ...
                : 'hover:shadow-xl hover:scale-110 bg-gradient-to-r from-purple-500 to-indigo-500'
          }`}
        >
          {isGenerating ? (
            <Loader2 className="w-8 h-8 text-white animate-spin" />
          ) : (
            <svg className="w-8 h-8 text-white animate-star-bounce animate-star-sparkle" fill="currentColor" viewBox="0 0 24 24">
